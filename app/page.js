  ...
  return (
    <div>
      <div className='max-w-2xl mx-auto'>
        <h1 className={`${neohellenic.className} text-4xl sm:text-6xl my-5`}>Iliad Translations</h1>
        ...
        <h2 className={`${neohellenic.className} text-3xl sm:text-5xl my-5`}>Compare Translations</h2>
      </div>
      <Selector data={translatorData}></Selector>
      <div className='max-w-2xl mx-auto'>
        <h2 className={`${neohellenic.className} text-3xl sm:text-5xl my-5`}>Individual Translations</h2>
        ...
        <div className='grid grid-cols-2 gap-4'>
          <div>
            <h2 className={`${neohellenic.className} text-3xl sm:text-5xl my-5`}>Most Read</h2>
          ...
          <div>
            <h2 className={`${neohellenic.className} text-3xl sm:text-5xl my-5`}>Most Liked</h2>
            <ol className='list-decimal list-inside'>
        ...
        <h2 className={`${neohellenic.className} text-3xl sm:text-5xl my-5`}>Comparisons</h2>
        <ul className='grid grid-cols-2'>
        ...
        <h2 className={`${neohellenic.className} text-3xl sm:text-5xl my-5`}>Further Reading</h2>
        <ul>
